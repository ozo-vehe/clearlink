...
<template>
  <header class="flex flex-wrap items-center justify-center gap-12 px-16">
    <div class="header_text w-[580px]">
      <h1 class="text-[#1D2939] text-[50px] font-[600] leading-[52px]">Uniting the world, <br />one video call at a time
      </h1>
      <p class="text-[#667085] text-[20px] mt-6 font-[400] leading-[28px] max-w-[600px]">Experience the future of
        communication with ClearLink – where crystal-clear video conferencing meets unparalleled simplicity.</p>

      <div class="header_btn flex items-center gap-5 mt-[48px]">
        <button
          class="rounded-[100px] py-4 px-7 flex items-center justify-center gap-1 bg-[#175cd3] shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)] text-white ">Start
          you free trial</button>
        <p class="text-[18px] text-[#175cd3] leading-[28px] font-[600] flex gap-3 items-center">
      ...
      <div class="community flex items-center gap-4 mt-12">
        <img :src="users" alt="Community">
        <div class="community_stars">
          <div class="stars_container flex gap-2 items-center">
            <div class="stars flex items-center">
              <img v-for="i in 5" :src="star" alt="Stars">
            </div>
            <p class="text-[#344054] font-[600]">5.0</p>
          </div>
          <p class="text-[#475467] font-[500]">from 3,000+ reviews</p>
        </div>
      </div>
    </div>

    <div class="header_img w-[500px] flex items-end">
      <img class="rounded-[16px] border-2 border-[#B2DDFF] w-full shadow-[0px_40px_20px_rgba(0,0,0,0.07)] h-full object-contain" :src="header_img" alt="Header image">
    </div>
  </header>
</template>
